...
<title>SentryLink | Reset Password</title>
...
<div class="auth-wrap">
    <div class="auth-card">
        ...
        <p class="copy">Use a password with at least 8 characters for your <?= h(strtolower($roleConfig[$role]['label'])) ?> account.</p>
        ...
        <?php else: ?>
            <a class="button-link" href="<?= h($loginUrl) ?>">Back to Login</a>
        <?php endif; ?>

        <?php if ($canReset): ?>
            <div class="back-link">
                <a href="<?= h($loginUrl) ?>">Back to login</a>
            </div>
        <?php endif; ?>
    </div>
</div>
